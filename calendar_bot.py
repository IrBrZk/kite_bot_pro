#!/usr/bin/env python3
# calendar_bot.py - бот с красивым календарем
import logging
...
def main():
    ...
    logger.info("🚀 Kite Bot Pro с красивым календарем запускается...")
    ...
    logger.info("✅ Бот с красивым календарем запущен и готов к работе!")
